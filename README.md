...
- **Início** — Apresentação pessoal e chamadas para ação ("Ver meus projetos" e "Entre em contato")
- **Ferramentas** — Ícones das tecnologias utilizadas no dia a dia
- **Projetos em destaque** — Cards com os principais projetos, tecnologias envolvidas e links para os repositórios no GitHub
...
- Cards de projeto com efeito de hover
...
```bash
git clone https://github.com/josecarlosalvesjunior-crypto/seu-repositorio.git
```
